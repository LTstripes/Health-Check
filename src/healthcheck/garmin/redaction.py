...
GARMIN_SAFE_FIELD_PATHS = frozenset(
    {
        ...
        "dailySleepDTO.sleepScores.totalDuration",
        "dailySleepDTO.sleepScores.totalDuration.value",
        "dailySleepDTO.sleepScores.stress",
        "dailySleepDTO.sleepScores.stress.value",
        "dailySleepDTO.sleepScores.awakeCount",
        "dailySleepDTO.sleepScores.awakeCount.value",
        "dailySleepDTO.sleepScores.remPercentage",
        "dailySleepDTO.sleepScores.remPercentage.value",
        "dailySleepDTO.sleepScores.restlessness",
        "dailySleepDTO.sleepScores.restlessness.value",
        "dailySleepDTO.sleepScores.lightPercentage",
        "dailySleepDTO.sleepScores.lightPercentage.value",
        "dailySleepDTO.sleepScores.deepPercentage",
        ...
        "metricDescriptors.key",
        "metricDescriptors.metricsIndex",
        ...
        "activities.avgPower",
        "activities.maxPower",
        "activities.normPower",
        "activities.aerobicTrainingEffect",
        "activities.anaerobicTrainingEffect",
        "activities.activityTrainingLoad",
        "activities.trainingEffectLabel",
        "activities.averageRunningCadenceInStepsPerMinute",
        "activities.maxRunningCadenceInStepsPerMinute",
