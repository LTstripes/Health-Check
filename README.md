...
The canonical Windows launcher prepares the external runtime, initializes the empty SQLite database with WAL/foreign-key pragmas, and starts the loopback listener on `127.0.0.1:8000`:
